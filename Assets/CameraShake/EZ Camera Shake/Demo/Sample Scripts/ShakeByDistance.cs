...
/*
 * This script shakes the camera based on the collision object's distance to the object this script is attached to.
 */
public class ShakeByDistance : MonoBehaviour
{
    ...
    //The maximum distance. If the collision is farther away than this distance then no shaking will be visible.
	...
	void Update ()
    {
        //Get the distance from the collision to this object.
